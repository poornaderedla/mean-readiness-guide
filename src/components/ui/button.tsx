  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:shadow-medium transform hover:scale-105 shadow-soft",
        premium: "bg-gradient-to-r from-accent to-primary text-accent-foreground hover:shadow-strong transform hover:scale-105",
        glass: "bg-white/10 backdrop-blur-sm text-primary-foreground border border-white/20 hover:bg-white/20",
      },
      size: {
